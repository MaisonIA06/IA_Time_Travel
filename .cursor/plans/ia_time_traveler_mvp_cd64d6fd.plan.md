...
overview: Création d'une WebApp éducative complète "IA Time Traveler" - un jeu de frise chronologique sur l'histoire de l'IA pour collégiens. Monorepo avec backend Django/DRF, frontend React/Vite/TS, PostgreSQL, le tout orchestré par Docker.
todos:
  - id: docker-setup
